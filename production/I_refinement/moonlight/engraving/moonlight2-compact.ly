...
bottom =  \relative c {
 ...
 \moveMarkup #'(0 . 1) <c as>_\markup { \override #'(baseline-skip . 1.4) \finger \column { "2" "3" } }-. r
            ...
            bes'-( |
 as2 ges4 |			%5
 f-.-) r \moveMarkup #'(0 . 1) <es ges,>_\markup { \override #'(baseline-skip . 1.4) \finger \column { "2" "5" } }-. | 
 ...
 \repeat volta 2 {
  ...
  \moveMarkup #'(0 . 1) <des f,>_\markup { \override #'(baseline-skip . 1.4) \finger \column { "1" "5" } }-.-) r <des bes>-( | 
  <des as>2 <c ges>4 |
...
\score {
 ...
 \layout {
  \context { \Voice \consists #md-note-tags \override TextScript.stencil = ##f \override Fingering.stencil = ##f }
