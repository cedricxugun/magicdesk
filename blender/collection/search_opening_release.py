...
results=[]
for step in [0.,.015,.03,.045,.06]:
 for phase_split in [False,True]:
...
(OUT/'release_options.json').write_text(json.dumps({'source_sha256':spec['source_sha256'],'options':results,'scope':'11 opening samples, porcelain shell pairs only. No fixed core/lip/support, reverse, continuous clearance or final mechanism validation. Motion alternatives require guided carriers.'},indent=2)+'\n')
