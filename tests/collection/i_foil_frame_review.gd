...
var world:Node3D
var camera:Camera3D
var out:="res://../review/I_refinement/part_a_mouth/shutter_r2/foil_frame/runtime/"
...
func run()->void:
    ...
    for group in spec.tongues:
        for name in group.mesh_names:
            ...
            candidate.shader=load("res://review/i_tongue_frame_candidate.gdshader");corrected_shaders.append(candidate)
